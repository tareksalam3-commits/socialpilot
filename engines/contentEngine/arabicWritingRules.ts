...
- ممنوع منعًا باتًا إدراج أي كلمة أو حرف من لغة غير العربية أو الإنجليزية — لا فرنساوي، لا إسباني، لا برتغالي، لا صيني، لا أي لغة أو خط (script) آخر، ولو كلمة واحدة وسط جملة عربية سليمة. الاستثناء الوحيد: مصطلحات إنجليزية تقنية/تجارية شائعة ومفهومة (مثل SaaS، CRM، ROI، KPI) عند الحاجة الفعلية، مكتوبة بحروف إنجليزية عادية (ASCII) بدون أي علامات تشكيل (accents) من لغات أخرى. لو حسّيت إنك مش متأكد من الترجمة الصحيحة لكلمة، اكتب أقرب مرادف عربي طبيعي بدل ما تُدخل الكلمة الأجنبية الأصلية.`;
}
