...
const {
  ...
  contentInsights: { Component: ContentInsightsPage },
  search: { Component: GlobalSearchPage },
  workspace: { Component: WorkspacePage },
  playground: { Component: ContentWorkspacePage },
            ...
            <Suspense fallback={<LoadingScreen />}>
              <Routes>
                ...
                >
                  ...
                  <Route path="posts" element={<Navigate to="/app/playground" replace />} />
                  <Route path="automation" element={<AutomationPage />} />
                  <Route path="media" element={<MediaLibraryPage />} />
                  <Route path="inbox" element={<InboxPage />} />
                  <Route path="notifications" element={<NotificationsPage />} />
                  <Route path="analytics" element={<AnalyticsPage />} />
                  <Route path="insights" element={<ContentInsightsPage />} />
                  <Route path="search" element={<GlobalSearchPage />} />
                  <Route path="workspace" element={<WorkspacePage />} />
                  <Route path="playground" element={<ContentWorkspacePage />} />
                  <Route path="studio" element={<ContentStudioPage />} />
                  <Route path="prompts" element={<PromptLibraryPage />} />
                  <Route path="ai-history" element={<AIHistoryPage />} />
                  <Route path="brand-voice" element={<BrandVoicePage />} />
                  <Route path="audience" element={<Navigate to="/app/brand-voice" replace />} />
                  <Route path="content-sources" element={<ContentSourcesPage />} />
                  <Route path="settings" element={<SettingsPage />} />
                  {/* Redirects from the pre-merge routes so old bookmarks/links keep working. */}
                  <Route path="scheduled" element={<Navigate to="/app/posts" replace />} />
                  <Route path="calendar" element={<Navigate to="/app/posts" replace />} />
                  <Route path="token-analytics" element={<Navigate to="/app/ai-history" replace />} />
                </Route>
                <Route
                  path="/admin"
                  element={
