...
export const pages = {
  ...
  calendar: page(() => import('@/features/posts/ContentCalendarPage'), 'ContentCalendarPage'),
  ...
  audience: page(() => import('@/features/audience/AudiencePage'), 'AudiencePage'),
  playground: page(() => import('@/features/ai/PlaygroundPage'), 'PlaygroundPage'),
...
export const preloadByPath: Record<string, () => Promise<unknown>> = {
  ...
  '/app/scheduled': pages.scheduled.preload,
  '/app/calendar': pages.calendar.preload,
  ...
  '/app/token-analytics': pages.tokenAnalytics.preload,
