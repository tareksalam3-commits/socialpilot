...
const SETTINGS_COLUMNS =
  'model_selection,provider,default_model,temperature,max_tokens,streaming,free_only_mode,mode,last_successful_model,last_successful_provider,created_at,updated_at';
