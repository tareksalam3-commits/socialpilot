...
تم اختبار Analytics Sync فعليًا في الإنتاج بعد نشر إصلاح UX؛ أعادت المزامنة نجاحًا واضحًا مع عدم وجود منشورات منشورة قابلة لجلب Metrics. تظل فجوة مصدر الحقيقة للوظائف الأخرى مفتوحة، خصوصًا وظائف OAuth والمنصات الإضافية ووظائف الإدارة. لن تُستبدل هذه الوظائف دون استعادة مصدرها أو بناء عقد متوافق مع المخطط الحالي.
