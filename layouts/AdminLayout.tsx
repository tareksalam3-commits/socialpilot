  ...
  const sidebarContent = (
    <>
      ...
      <div className="border-t border-slate-800 p-2">
        ...
        {/* Plain always-visible button — the old dropdown item rendered
            behind the mobile drawer's own backdrop (same z-index tier),
            making it invisible and unclickable on mobile. */}
        <button
          onClick={handleSignOut}
          className="mt-1 flex w-full items-center gap-2 rounded-lg px-2 py-2 text-sm font-medium text-rose-400 transition-colors duration-150 hover:bg-rose-950/40"
        >
